...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    tools: {
      ...
      examQuestionContext: 'Контекст экзаменационного задания',
      examQuestionContextDesc: 'Получение текста, вопросов, вариантов, ответов и объяснений',
      examLearningDiagnosis: 'Диагностика обучения',
      examLearningDiagnosisDesc: 'Читает ошибки ученика, ответы, объяснения и статус повторения для анализа пробелов',
      examClassDiagnosis: 'Диагностика класса',
      examClassDiagnosisDesc: 'Сводка прогресса класса, частых ошибок, динамики освоения и учеников, требующих внимания',
      examPracticeRecommendation: 'Рекомендация практики',
      examPracticeRecommendationDesc: 'Рекомендует существующие структурированные группы заданий по данным диагностики ученика или класса',
      ...
      // Группы
      groupBase: 'Базовые',
      groupLearning: 'Диагностика обучения',
  ...
  organization: {
    ...
    rbac: {
      needTenantAdmin: 'Требуется роль администратора общего пространства',
      needTenantAdminTip: 'Для этого действия требуется роль admin или Owner в этом общем пространстве. Обратитесь к владельцу пространства.',
      cannotCreate: 'Эта учетная запись не может создать общее пространство',
      cannotJoin: 'Эта учетная запись не может присоединиться к общему пространству или запросить присоединение',
      cannotManage: 'Эта учетная запись не может управлять этим общим пространством',
    },
    join: {
      title: 'Join Space',
