export default {
  ...
  auth: {
    ...
    resetPasswordRequestDesc: "输入账号邮箱后，系统会生成一个 30 分钟内有效的一次性重置令牌。若该邮箱不存在，页面也会返回相同提示。",
    resetPasswordConfirmDesc: "输入重置令牌和新密码。重置成功后，该账号原有登录状态会失效。",
    sendResetToken: "获取重置令牌",
    resetToken: "重置令牌",
    resetTokenPlaceholder: "输入邮箱中收到的重置令牌",
    resetTokenRequired: "请输入重置令牌",
    resetPasswordMinLength: "密码至少6个字符",
    devResetTokenHint: "开发环境已生成重置令牌，并自动填入下方输入框。",
    backToEmail: "返回邮箱",
    resetPasswordSubmit: "确认重置",
    resetPasswordRequestSuccess: "重置令牌已生成，请继续设置新密码",
    resetPasswordRequestFailed: "获取重置令牌失败",
  ...
  error: {
    ...
    auth: {
      ...
      requestPasswordResetFailed: "获取重置令牌失败",
      resetPasswordFailed: "密码重置失败",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      examQuestionContext: "考试题组上下文",
      examQuestionContextDesc: "获取试题原文、题目、选项、答案和解析",
      examLearningDiagnosis: "学习诊断",
      examLearningDiagnosisDesc: "读取当前学生错题、答案、解析和复习状态，辅助分析薄弱点",
      examClassDiagnosis: "班级诊断",
      examClassDiagnosisDesc: "汇总班级练习进度、高频错题、掌握趋势和需关注学生",
      examPracticeRecommendation: "练习推荐",
      examPracticeRecommendationDesc: "根据学生或班级诊断证据推荐可练习的正式题组",
      listChunks: "查看文档分块",
