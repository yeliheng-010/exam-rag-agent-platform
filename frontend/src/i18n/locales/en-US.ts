export default {
  ...
  auth: {
    ...
    resetPasswordRequestDesc: 'Enter your account email to generate a single-use reset token valid for 30 minutes. The same message is shown even if the email does not exist.',
    resetPasswordConfirmDesc: 'Enter the reset token and a new password. Existing sessions for this account will be revoked after reset.',
    sendResetToken: 'Get Reset Token',
    resetToken: 'Reset Token',
    resetTokenPlaceholder: 'Enter the reset token from your email',
    resetTokenRequired: 'Enter reset token',
    resetPasswordMinLength: 'Password must be at least 6 characters',
    devResetTokenHint: 'A reset token was generated in development mode and filled below.',
    backToEmail: 'Back to Email',
    resetPasswordSubmit: 'Reset Password',
    resetPasswordRequestSuccess: 'Reset token generated. Continue setting a new password.',
    resetPasswordRequestFailed: 'Failed to get reset token',
...
\
  ...
  error: {
    ...
    auth: {
      ...
      requestPasswordResetFailed: 'Failed to get reset token',
      resetPasswordFailed: 'Password reset failed',
  ...
  organization: {
    ...
    rbac: {
      needTenantAdmin: 'Shared space admin role required',
      needTenantAdminTip: 'This action requires the admin role or Owner role in this shared space. Please contact the space owner.',
      cannotCreate: 'This account cannot create a shared space',
      cannotJoin: 'This account cannot join or request to join a shared space',
      cannotManage: 'This account cannot manage this shared space',
    },
    join: {
      title: 'Join Space',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      examQuestionContext: 'Exam Question Context',
      examQuestionContextDesc: 'Retrieve exam passages, questions, options, answers, and explanations',
      examLearningDiagnosis: 'Learning Diagnosis',
      examLearningDiagnosisDesc: 'Read current student wrong questions, answers, explanations, and review status for mastery analysis',
      examClassDiagnosis: 'Class Diagnosis',
      examClassDiagnosisDesc: 'Summarize class practice progress, frequent wrong questions, mastery trends, and students needing attention',
      examPracticeRecommendation: 'Practice Recommendation',
      examPracticeRecommendationDesc: 'Recommend existing structured question groups from student or class diagnosis evidence',
      ...
      // Groups
      groupBase: 'Basic',
      groupLearning: 'Learning Diagnosis',
