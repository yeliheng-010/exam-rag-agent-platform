export default {
  ...
  organization: {
    ...
    rbac: {
      needTenantAdmin: "공유 공간 관리자 권한이 필요합니다",
      needTenantAdminTip: "이 작업은 이 공유 공간의 admin 또는 Owner 권한이 필요합니다. 공간 Owner에게 문의하세요.",
      cannotCreate: "현재 계정은 공유 공간을 만들 수 없습니다",
      cannotJoin: "현재 계정은 공유 공간에 가입하거나 가입을 신청할 수 없습니다",
      cannotManage: "현재 계정은 이 공유 공간을 관리할 수 없습니다",
    },
    join: {
      title: "스페이스에 참여하기",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      examQuestionContext: '시험 문항 맥락',
      examQuestionContextDesc: '시험 지문, 문항, 선택지, 정답과 해설 조회',
      examLearningDiagnosis: '학습 진단',
      examLearningDiagnosisDesc: '현재 학생의 오답, 답안, 해설과 복습 상태를 읽어 취약점을 분석',
      examClassDiagnosis: '학급 진단',
      examClassDiagnosisDesc: '학급 연습 진행률, 빈번한 오답, 숙련도 추세와 주의가 필요한 학생 요약',
      examPracticeRecommendation: '연습 추천',
      examPracticeRecommendationDesc: '학생 또는 학급 진단 근거를 바탕으로 기존 구조화 문항 그룹 추천',
      listChunks: '문서 청크 보기',
